...
export function ShareButton({ title, currentPrice, itemId }: ShareButtonProps) {
  const [copied, setCopied] = useState(false)

  const url = typeof window !== "undefined" ? `${window.location.origin}/${itemId}` : ""

  const shareText = `Check out this auction: ${title} - Current bid: ${currentPrice.toFixed(0)} SAR`
